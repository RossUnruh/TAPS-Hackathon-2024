...
overview_tab_layout = dcc.Tab(label="Overview", children=[
    html.Div([
        html.H1("Water Intelligence Dashboard for Sustainable Agriculture"),
        
        html.P("This dashboard provides data analysis and visualizations from TAPS (Testing Ag Performance Solutions) Project—an interactive farm management competition with 34 participating teams. The purpose of this dashboard is to support farmers and competitors by highlighting trends and insights from their plots, guiding more effective and sustainable management decisions."),
        
        html.H2("Dashboard Overview"),
        html.P("The dashboard is organized into eight primary tabs, each focusing on different aspects of data analysis:"),

        # List of tabs with buttons to switch tabs
        html.P([
            html.Li(html.Button("1. TAPS Management", id="btn-management-tab")),
            html.Li(html.Button("2. Environmental Parameters", id="btn-environment-tab")),
            html.Li(html.Button("3. Spatial Analysis", id="btn-spatial-tab")),
            html.Li(html.Button("4. Soil Moisture Sensor-based SW Management", id="btn-soil-sensor-tab")),
            html.Li(html.Button("5. Weather-based SW Management", id="btn-weather-tab")),
            html.Li(html.Button("6. Satellite-based SW Management", id="btn-satellite-tab")),
            html.Li(html.Button("7. Neutron Probe Data Analysis", id="btn-neutron-tab"))
        ]),
